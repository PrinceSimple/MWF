...
export default class MediaEditViewController extends mwf.ViewController {
    ...
    constructor() {
        ...
        console.log("MediaEditViewController()");
    }
     ...
     */
    async oncreate() {
        const mediaItem = new entities.MediaItem("New Item", "https://placeimg.com/200/100")
        this.bindElement("mediaEditViewTemplate", {item:mediaItem}, this.root)

        this.root.querySelector("main form").onsubmit = () => {
            console.log("TATADA");
            return false
        }
